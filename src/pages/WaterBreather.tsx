...
const WaterBreather = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-900 via-cyan-800 to-blue-950 text-white">
      ...
      {/* Ripple effects */}
      <div className="absolute top-1/4 left-1/4 w-48 h-48 ripple-effect" style={{ animationDelay: "0s" }} />
      <div className="absolute bottom-1/3 right-1/3 w-64 h-64 ripple-effect" style={{ animationDelay: "1s" }} />
      <div className="absolute top-2/3 left-1/2 w-32 h-32 ripple-effect" style={{ animationDelay: "2s" }} />
          ...
          >
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-xl border-2 border-cyan-500/50">
                <img
                  src="/lovable-uploads/a077f559-77fa-46dc-bf68-243b7b7b87f1.png"
                  alt="Water Breather Cosplay"
            ...
            <div className="glass-panel rounded-xl p-8 backdrop-blur-md bg-blue-950/30 border border-cyan-500/20">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-blue-200">Patterned fabrics with wave-like designs and geometric elements</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2" />
                  <p className="text-blue-200">Digital art projection techniques for the water effects</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2" />
                  <p className="text-blue-200">Hand-painted detailing on costume accessories and props</p>
                </div>
              </div>
